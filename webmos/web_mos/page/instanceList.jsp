							...
							<tr>
								<td class="ctd"><bean:write name="instance" property="instanceName"/></td>
							 	...
							 	<td class="ctd">
							 		 ...
							 		 <a href="../tm/instanceSettingAction.do?method=editInstanceMainInit&instanceId=<bean:write name='instance' property='queryInstanceId' />&typeFlag=<bean:write name='instance' property='instanceType' />" >修改</a>&nbsp;&nbsp;
