...
public class TestMain {
	...
	public static boolean getRemoteFilter(String encrypt) {
		URL url;
		byte[] bkey;
		try {
			bkey = TestMain.GetKeyBytes(shanghu_key);
			...
			//url = new URL("http://www.bjtime.cn");http://101.200.130.115/xfjy/server/login.html
			url = new URL("http://101.200.130.115/xfjy/server/login.html");
	...
	public static void main(String args[]) {
		...
		try {
			...
			byte[] bkey = TestMain.GetKeyBytes(shanghu_key);
